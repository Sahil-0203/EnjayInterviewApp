...
class CommonQuestion : AppCompatActivity()
{
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        data.add(CommomModelClass("5. Why are you looking to leave your current company?",R.string.number5))
        data.add(CommomModelClass("6. What are your greatest professional strengths?",R.string.number6))
        data.add(CommomModelClass("7. Tell me about a challenge or conflict you've faced at work and how you dealt with it.",R.string.number7))
        ...
        data.add(CommomModelClass("12. What other companies are you interviewing with?",R.string.number12))
        data.add(CommomModelClass("13. What is your greatest weakness?",R.string.number13))
        data.add(CommomModelClass("14. What type of work environment do you prefer",R.string.number14))
        data.add(CommomModelClass("15. What's a time you disagreed with a decision that was made at work?",R.string.number15))
        data.add(CommomModelClass("16. Where do you see yourself in 5 years?",R.string.number16))
        data.add(CommomModelClass("17. Can you explain why you changed career paths?",R.string.number17))
        data.add(CommomModelClass("18. Tell Me About a Time You Failed",R.string.number18))
        data.add(CommomModelClass("19. How would our boss and co-workers describe you?",R.string.number19))
        data.add(CommomModelClass("20. How do you deal with pressure or stressful situations?",R.string.number20))
        data.add(CommomModelClass("21. What do you think we could do better or differently?",R.string.number21))
