...
class Web_technical : AppCompatActivity()
{
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        data.add(CommomModelClass("1. What are the prerequisites of being a web developer?",R.string.web1))
        data.add(CommomModelClass("2. Enlist the advantages of HTTP/2 as compared with HTTP 1.1/.",R.string.web2))
