...
class PhpQuestion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_php_question)
        ...
        questionsList.add(QuestionModel("hello Kem cho","A flow of water","A flow of air","A flow of electrons"," A flow of atoms","A flow of electrons"))
